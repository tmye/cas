...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'cas_new', 'user' => 'root', 'password' => 123456, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/AppBundle/Entity'), 1 => ($this->targetDirs[3].'/src/DeviceManagerBundle/Entity')));
        ...
        $d->addDriver($b, 'DeviceManagerBundle\\Entity');
        $d->addDriver($c, 'FOS\\UserBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('AppBundle' => 'AppBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'DeviceManagerBundle' => 'DeviceManagerBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_84a9adc85e4224c1e316fc258c55562512b00c9f1ef2cd465cde4217920d73a0');
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/SupAdmin/');
        ...
        $l->add($k, array(0 => 'ROLE_SUPER_ADMIN'), NULL);

        $m = new \Symfony\Component\Security\Core\User\InMemoryUserProvider();
        $m->createUser(new \Symfony\Component\Security\Core\User\User('foo', 'test', array(0 => 'ROLE_USER')));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/DeviceManagerBundle/Resources/views'), 'DeviceManager');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('f77c6b73e68075dba2a6a0c24022578ec9227143');
    }
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_SECRET' => array(0 => 'ROLE_USER'), 'ROLE_ADMIN' => array(0 => 'ROLE_SECRET'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'DeviceManagerBundle' => 'DeviceManagerBundle\\DeviceManagerBundle',
            ...
            'kernel.bundles_metadata' => array(
                ...
                'DeviceManagerBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/DeviceManagerBundle'),
                    'namespace' => 'DeviceManagerBundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
            ...
            'secret' => 'f77c6b73e68075dba2a6a0c24022578ec9227143',
            'locale' => 'en',
            ...
            'kernel.secret' => 'f77c6b73e68075dba2a6a0c24022578ec9227143',
